...
const LandingPage = () => {
  return (
    <div className="mx-auto max-w-screen-xl px-8 bg-white">
      ...
      <main className="flex-1">
        ...
        <section id="Features" className="w-full py-8 md:py-12 lg:py-32  lg:pt-6">
          <div className="container grid items-center justify-center gap-2 px-4 text-center md:px-6 ">
            ...
            <div className="grid grid-cols-3 gap-4 md:grid-cols-3 justify-center">
              ...
              <div className="p-4 bg-gray-200 rounded-lg">
                ...
                <p className="text-gray-600">
                  Scale your projects effortlessly with cloud deployment
                  options.
                </p>
              </div>
            </div>
      ...
      <footer className="flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t">
        <p className="text-xs text-gray-500 dark:text-gray-400">
          © 2024 AJA Inc. All rights reserved.
        </p>
